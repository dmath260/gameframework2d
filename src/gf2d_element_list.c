...
{
    ListElement *list;
    GFC_Vector2D position = {0},drawPosition = {0};
    int count,i;
    Element *e;
    GFC_List *ret = NULL;
    GFC_List *updated;
...
ListElement *gf2d_element_list_new_full(GFC_Rect bounds, GFC_Vector2D itemSize,ListStyle ls,int wraps,int scrolls,int packed,int cropped)
{
    ListElement *list;
