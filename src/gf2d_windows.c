...
void gf2d_draw_window_border_tiled(Sprite *border,Sprite *bg, GFC_Rect rect, GFC_Color color)
{
    ...
    for (i = 0; i  < count.x; i++)
    {
        gf2d_sprite_draw(
            border,
            gfc_vector2d(rect.x + border->frame_w/2 + (i * border->frame_w),rect.y - border->frame_w/2),
            NULL,
            NULL,
            NULL,
            NULL,
        ...
        gf2d_sprite_draw(
            border,
            gfc_vector2d(rect.x + border->frame_w/2 + (i * border->frame_w),rect.y + rect.h - border->frame_w/2),
            NULL,
            NULL,
            NULL,
            NULL,
    ...
    for (i = 0; i  < count.y; i++)
    {
        gf2d_sprite_draw(
            border,
            gfc_vector2d(rect.x - border->frame_w/2,rect.y + border->frame_w/2 +  + (i * border->frame_h)),
            NULL,
            NULL,
            NULL,
            NULL,
        ...
        gf2d_sprite_draw(
            border,
            gfc_vector2d(rect.x + rect.w - border->frame_w/2,rect.y + border->frame_w/2 +  + (i * border->frame_h)),
            NULL,
            NULL,
            NULL,
            NULL,
    ...
    gf2d_sprite_draw(
        border,
        gfc_vector2d(rect.x + rect.w - border->frame_w/2,rect.y - border->frame_w/2),
        NULL,
        NULL,
        NULL,
        NULL,
    ...
    gf2d_sprite_draw(
        border,
        gfc_vector2d(rect.x - border->frame_w/2,rect.y + rect.h - border->frame_w/2),
        NULL,
        NULL,
        NULL,
        NULL,
    ...
    gf2d_sprite_draw(
        border,
        gfc_vector2d(rect.x - border->frame_w/2,rect.y - border->frame_w/2),
        NULL,
        NULL,
        NULL,
        NULL,
    ...
    gf2d_sprite_draw(
        border,
        gfc_vector2d(rect.x + rect.w - border->frame_w/2,rect.y + rect.h - border->frame_w/2),
        NULL,
        NULL,
        NULL,
        NULL,
...
Window *gf2d_window_load_from_json(SJson *json)
{
    ...
    int i,count;
    short int buul = 0;
    GFC_Vector4D vector = {255,255,255,255};
